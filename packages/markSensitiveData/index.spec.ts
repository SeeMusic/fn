...
describe('util / markSensitiveData', () => {
  it('指定字符串两边保留字符个数： 第 0 个开始保留最后 0 个', () => {
    expect(markSensitiveData('0123456789', 0)).toBe('**********')
  })

  it('指定字符串两边保留字符个数： 第 1 个开始保留最后 1 个', () => {
